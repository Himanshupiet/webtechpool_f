...
const correctULTagFromQuill =  (inputString:string) => {
  const ulReplace =  inputString.replace(/<ul>/g, "<ul class='mb-10 list-inside list-disc text-body-color'>");
  const liReplace =  ulReplace.replace(/<li>/g, "<li class='mb-2 text-base font-medium text-body-color sm:text-lg lg:text-base xl:text-lg'>");
  const strongReplce = liReplace.replace(/<strong(.*?)>/g, "<strong class='text-justify text-primary dark:text-white'>")
  const pTagReplce = strongReplce.replace(/<p>/g, "<p class='text-justify'>")
  const spanTagReplace = pTagReplce.replace(/<span(.*?)>/g,"<span class='font-bold'>")
  return spanTagReplace
}
  ...
  useEffect(() => {
      if(pathname && pathname.split("/")[2]){
        dispatch(getBlogById(pathname.split("/")[2])).unwrap().then((res:any)=>{
          ...
          if(res.data){
            //console.log("res.datares.datares.data", correctULTagFromQuill(res.data.blogContent))
            setTimeout(() => {
                ...
                <div>
                  ...
                  <div className="mb-10 flex flex-wrap items-center justify-between border-b border-body-color border-opacity-10 pb-4 dark:border-white dark:border-opacity-10">
                    <div className="flex flex-wrap items-center">
                      ...
                      <div className="mb-5 flex items-center">
                        <p className="mr-5 flex items-center text-base font-medium text-body-color">
                          ...
                          {blogDetails?.created? new Date(blogDetails.created).toDateString(): new Date().toDateString()}
                        </p>
                        <p className="mr-5 flex items-center text-base font-medium text-body-color">
                          <span className="mr-3">
                            <svg
                    ...
                    <div className="mb-5">
                      <a
                        href="#0"
                        className="inline-flex items-center justify-center rounded-full bg-primary py-2 px-4 text-sm font-semibold capitalize text-white"
                      >
                        {blogDetails?.tags[0]}
                      </a>
                    </div>
                  ...
                  <div>
                    ...
                    <div className="mb-10 w-full overflow-hidden rounded">
                      <div className="relative aspect-[97/60] w-full sm:aspect-[97/44]">
                        <Image
                          src={blogDetails?.bannerImageUrl}
                          alt="image"
                          fill
                    ...
                    <p className="mb-10 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                      {blogDetails?.blogMetaTag}
                    </p>
                    <div dangerouslySetInnerHTML={{__html:  correctULTagFromQuill(blogDetails?.blogContent)}}></div>
